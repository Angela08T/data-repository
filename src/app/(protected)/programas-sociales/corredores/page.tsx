...
function SexoBadge({ sexo }: { sexo?: string | null }) {
  ...
  return (
    <span className="inline-block px-2 py-0.5 rounded text-xs font-bold"
      style={s === "F" ? { background: "#fdf2f8", color: "#9d174d" } : { background: "#eff6ff", color: "#1d4ed8" }}>
...
export default function CorredoresPage() {
  ...
  const COLS            = 7; // nombre + email + dni + nacimiento/edad + sexo + celular + llamado
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-black" style={{ color: "#0d1b3e" }}>Corredores</h1>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr style={{ background: "#f8fafc" }}>
                {["Nombres y Apellidos", "Email", "DNI", "Nacimiento", "Edad", "Sexo", "Celular", "Llamado"].map((h) => (
                ...
                paginados.map((c, i) => {
                  ...
                  return (
                    <tr key={c.id}
                      ...
                      {/* Nacimiento */}
                      <td className="px-4 py-3 whitespace-nowrap">
                        <span className="text-sm text-gray-600">{c.fecha_nacimiento || "—"}</span>
                      </td>
                      ...
                      {/* Celular */}
                      <td className="px-4 py-3">
                        <span className="text-sm text-gray-600">{tienePhone ? (c.telefono!.startsWith("+") ? c.telefono : `+51 ${c.telefono}`) : "—"}</span>
                      </td>
